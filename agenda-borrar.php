...
?>
    ...
    <div class="container">
        ...
        <form action="agenda-borrar.php" method="POST" name="agenda-borrar">
            ...
            <div class="form-group row">
                <div class="col-8 offset-2">
                    ...
                    <input disabled value="<?php echo $nombre?>" type="text" class="form-control" id="txtNombre" name="txtNombre">
                </div>
            </div>        
            <div class="form-group row">
                <div class="col-8 offset-2">
                    <label for="txtEmail">Email</label>
                    <input disabled value="<?php echo $email?>" type="email" class="form-control" id="txtEmail" name="txtEmail">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-8 offset-2">
                    ...
                    <input disabled value="<?php echo $telefono?>" type="text" class="form-control" id="txtTelefono" name="txtTelefono">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-8 offset-2">
                    <input name="enviar" type="submit" id="enviar" value=" Borrar Contacto " class="btn btn-primary"> 
